...
class data_loader_SatVu():

  def __init__(self,dataset_name='train'):
    self.dataset_name=dataset_name
    if dataset_name=='train':
      self.img_path=glob.glob('../Dataset/SatVu/train_input/*')
      self.input_path='../Dataset/SatVu/train_input/'
      self.label_path='../Dataset/SatVu/train_label/'
      self.template_path='../Dataset/SatVu/train_template/'

    elif dataset_name=='val':
      self.img_path=glob.glob('../Dataset/SatVu/val_template/*')
      self.input_path='../Dataset/SatVu/val_input/'
      self.label_path='../Dataset/SatVu/val_label/'
      self.template_path='../Dataset/SatVu/val_template/'
